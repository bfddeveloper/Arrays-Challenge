...
struct ContentView: View {
     ...
     ************************************/
    @State private var myFavoriteMovies : [String]? = ["nemo", "finding dory", "smile", "inception", "shrek"]
                ...
                if s1Check == 0 {
                    Button("Test Stretch 1") {
                        ...
                        if var myFavoriteMovies = myFavoriteMovies {
                            ...
                            myFavoriteMovies.insert("nemo 2", at: 1)
                            myFavoriteMovies.append("The Terrfier")
                            myFavoriteMovies.insert("IT chapter 13", at: 2)
